...
export const commands: Command = [
  { cmd: "gui", desc: "change to portfolio", tab: 25 },
  { cmd: "about", desc: "about Samyam", tab: 20 },
  { cmd: "echo", desc: "print out anything", tab: 21 },
  { cmd: "education", desc: "my education", tab: 12 },
  { cmd: "email", desc: "send an email to me", tab: 20 },
  { cmd: "help", desc: "check available commands", tab: 21 },
  { cmd: "history", desc: "view command history", tab: 16 },
  { cmd: "projects", desc: "view my projects", tab: 14 },
  // { cmd: "pwd", desc: "print current working directory", tab: 10 },
  { cmd: "socials", desc: "check out my social accounts", tab: 16 },
  { cmd: "themes", desc: "check available themes", tab: 15 },
  { cmd: "welcome", desc: "display welcome section", tab: 12 },
  // { cmd: "whoami", desc: "about current user", tab: 14 },
  { cmd: "clear", desc: "clear the terminal", tab: 20 },
  { cmd: "experience", desc: "show experiences", tab: 9 },
  { cmd: "sl", desc: "call the train", tab: 25 },
  { cmd: "exit", desc: "exit terminal mode", tab: 21 },
];
